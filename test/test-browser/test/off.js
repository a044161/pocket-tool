...
describe('off Test', function() {
	...
	describe('Error 相关', function() {
		it('参数1传入[]为错误类型', function() {
			off.bind(this, [], 'none', noFn).should.throw();
		});

		it('参数1传入null为错误类型', function() {
			off.bind(this, null, 'none', noFn).should.throw();
		});

		it('参数1传入undefined为错误类型', function() {
			off.bind(this, undefined, 'none', noFn).should.throw();
		});
		...
		it('参数1传入1为错误类型', function() {
			off.bind(this, 1, 'none', noFn).should.throw();
		});

		it('参数1传入function为错误类型', function() {
			off.bind(this, noFn, 'none', noFn).should.throw();
		});
		...
		it('参数2传入undefined为错误类型', function() {
			off.bind(this, getElement_target_1, undefined, noFn).should.throw();
		});
		...
		it('参数3传入null为错误类型', function() {
			off.bind(this, getElement_target_1, 'none', null).should.throw();
		});
